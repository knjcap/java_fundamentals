...
public class Exercise_03 {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Please enter number from 1 to 12 and program will match it against the month: ");
        int numberMonth = scanner.nextInt();
            switch(numberMonth) {
                ...
                case 12:
                    ...
                    break;
                default :
                    System.out.println("You have not entered the number from 1 to 12");
                    break;
            }
    }
